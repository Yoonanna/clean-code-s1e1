...
var taskInput = document.getElementById("add__title");//Add a new task.
var addButton = document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder = document.getElementById("todo__list");//ul of #todo__list
var completedTasksHolder = document.getElementById("complete__list");//complete__lists
...
var addTask = function () {
  ...
  //Create a new list item with the text from the #add__title:
...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("todo__list-edit");
  ...
  listItem.classList.toggle("todo__list-edit");
};
